...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    efficiency_zone = (generated_power/theoretical_max_power)*100
    if efficiency_zone >= 80:
        return "green"
    elif efficiency_zone <80 and efficiency_zone >= 60:
        return "orange"
    elif efficiency_zone < 60 and efficiency_zone >= 30 :
        return "red"
    else:
        return "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    porcento = ((temperature * neutrons_produced_per_second)/threshold)*100
    
    if porcento < 90:
        return "LOW"
    elif (porcento <= 10 and porcento >= 0) or (porcento == 100) or (porcento >= 90 and porcento <= 110 ):
        return "NORMAL"
    else:
        return "DANGER"
