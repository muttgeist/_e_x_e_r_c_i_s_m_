...
def preparation_time_in_minutes(layers):
    ...
    Returns:
        int: The time (in minutes) derived from 'PREPARATION_TIME_X_LAYER'.

    Function that takes the number of layers for the lasagna as
    an argument and returns how long it takes to prepare
    based on the `PREPARATION_TIME_X_LAYER`.
    """
    return PREPARATION_TIME_X_LAYER * layers
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    This function should return the total minutes you have been in the kitchen cooking — your 
