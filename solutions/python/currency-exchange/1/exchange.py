...
def get_change(budget, exchanging_value):
    ...
    Parameters:
        budget (float): The amount of money you own. Amount of money before exchange.
        exchanging_value (float): The amount of your money you want to exchange now. Amount of money that is taken from the budget to be exchanged.
